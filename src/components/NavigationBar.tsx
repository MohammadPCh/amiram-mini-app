...
const ITEMS: NavItem[] = [
  { key: "ranking", label: "رتبه بندی", href: "/ranking", icon: "/images/navigation/race.svg" },
  { key: "rewards", label: "جوایز", href: "/rewards", icon: "/images/navigation/wallet.svg", badge: 12 },
  { key: "wheel", label: "گردونه", href: "/wheel", icon: "/images/navigation/wheel.svg" },
  { key: "friends", label: "دوستان", href: "/friends", icon: "/images/navigation/freinds.svg" },
  { key: "home", label: "خانه", href: "/", icon: "/images/navigation/home.svg" },
];
